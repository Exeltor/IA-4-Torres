...
public class NQueensSearchDemo {
	...
	public void setBoardSize(int size) {
		boardSize = size;
		board = new FourTowersBoard(boardSize);
	}
	...
	public void initExperiment(Config config) {
		board = new FourTowersBoard(boardSize, config);
		genAlgo = null;
		search = null;
	}
	...
	public void startHillClimbingExperiment() {
		...
		board = (FourTowersBoard) ((HillClimbingSearch) search).getLastState();
		notifyProgressTrackers(board, search.getMetrics());
	}
	...
	public void startSimulatedAnnealingExperiment() {
		...
		board = (FourTowersBoard) ((SimulatedAnnealingSearch) search).getLastState();
		notifyProgressTrackers(board, search.getMetrics());
	}
	...
	private void printProgress(FourTowersBoard board, Metrics metrics) {
	...
	private void notifyProgressTrackers(FourTowersBoard board, Metrics metrics) {
		for (ProgressTracker tracker : progressTracers)
			tracker.trackProgress(board, metrics);
	}

	public interface ProgressTracker {
		void trackProgress(FourTowersBoard board, Metrics metrics);
	}
}
