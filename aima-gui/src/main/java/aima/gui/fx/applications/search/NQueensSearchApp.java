...
public class NQueensSearchApp extends IntegrableApplication {
	...
	public void startExperiment() {
		...
		if (strategy.equals("Depth-First Search (incremental)"))
			...
			experiment.startExperiment(new GreedyBestFirstSearch<>(new GraphSearch<>(),
					FourTowersFunctions::getNumberOfAttackingPairs));
	 ...
	 */
	private void updateStateView(FourTowersBoard board, Metrics metrics) {
	 ...
	 */
	private void updateStateViewLater(FourTowersBoard board, Metrics metrics) {
