...
public class NQueensCspApp extends IntegrableApplication {
    ...
    public void initialize() {
        ...
        stepCounter.reset();
        stateViewCtrl.update(new FourTowersBoard(csp.getVariables().size()));
    ...
    public void startExperiment() {
        ...
        if (solution.isPresent()) {
            FourTowersBoard board = getBoard(solution.get());
            stateViewCtrl.update(board);
        }
    }

    private FourTowersBoard getBoard(Assignment<Variable, Integer> assignment) {
        FourTowersBoard board = new FourTowersBoard(csp.getVariables().size());
        for (Variable var : assignment.getVariables()) {
            ...
            board.addTowerAt(new XYLocation(col, row));
        }
        return board;
    }
     ...
     */
    private void updateStateView(FourTowersBoard board) {
        Platform.runLater(() -> {
